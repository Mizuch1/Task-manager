        ...
        <div className="relative" ref={profileDropdownRef}>
          ...
          {profileDropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 origin-top-right rounded-md bg-white dark:bg-slate-700 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
              <ReactRouterDOM.Link to="/profil" className="flex items-center px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-600">
                <User className="mr-2 h-4 w-4" /> Profil
              </ReactRouterDOM.Link>
              <ReactRouterDOM.Link to="/parametres" className="flex items-center px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-600">
